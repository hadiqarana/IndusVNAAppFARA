...
public class SignInFlow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_in_flow);
        createSignInIntent();
    }
    ...
    private void onSignInResult(FirebaseAuthUIAuthenticationResult result) {
        ...
        if (result.getResultCode() == RESULT_OK) {
            ...
            Intent i = new Intent(SignInFlow.this, EditTextActivity.class);
            startActivity(i);
            // ...
        } else {
